...
public class actionUtils {
    ...
    public static void clickOnCareerButton(By xpath, int timeoutInSeconds) {
        WebDriverWait wait = new WebDriverWait(browserDriver.driver, Duration.ofSeconds(timeoutInSeconds));
    ...
    public static void clickOnAppleNow() {
        JavascriptExecutor js = (JavascriptExecutor) browserDriver.driver;
        WebElement button = browserDriver.driver.findElement(homePage.AppleNow_Button);
        js.executeScript("arguments[0].scrollIntoView(true);", button);
    ...
    public static void appleFormValidation(int timeoutInSeconds, String User_First_Name, String User_Last_Name, String User_Phone, String User_Email, String File_Name) throws InterruptedException {
        WaitUtils.waitForElement(browserDriver.driver, careersPage.Submit_Button, timeoutInSeconds);
        Thread.sleep(2000);
    ...
    public static void upload(String File_Name) {
        ...
        WebElement fileInput = browserDriver.driver.findElement(careersPage.UploadResume);
        fileInput.sendKeys(uploadFile.getAbsolutePath());
    }


    public static void formFirstName(String User_First_Name) {
        WebElement LastName = browserDriver.driver.findElement(careersPage.input_First_Name);
        LastName.click();
        LastName.sendKeys(User_First_Name);
    }

    public static void formLastName(String User_Last_Name) {
        WebElement LastName = browserDriver.driver.findElement(careersPage.input_Last_Name);
        LastName.click();
        LastName.sendKeys(User_Last_Name);
    }

    public static void formEmail(String User_Email) {
        WebElement LastName = browserDriver.driver.findElement(careersPage.input_Email);
        LastName.click();
        LastName.sendKeys(User_Email);
    }

    public static void formPhone(String User_Phone) {
        WebElement LastName = browserDriver.driver.findElement(careersPage.input_Phone);
        LastName.click();
